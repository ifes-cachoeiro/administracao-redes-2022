...
def topology(remote_controller):
    ...
    net.addLink(r1, switch1, bw=BW) # r1(1)
    # Rede B
    net.addLink(h1B, switch2, bw=BW)
    net.addLink(h2B, switch2, bw=BW)
    net.addLink(r11, switch2, bw=BW) # r11(1)
    # Rede C
    ...
    net.addLink(r5, r6, bw=BW) # r5(2), r6(1)
    net.addLink(r5, r8, bw=BW) # r5(3), r8(1)
    ...
    # Adicionar as rotas
    # r1
    addRoute(r1, "203.0.113.0/24 via 10.10.100.2")
    addRoute(r1, "198.51.100.0/24 via 10.10.100.2")
    addRoute(r1, "192.168.10.0/24 via 10.10.100.2")
    # r2
    addRoute(r2, "203.0.113.0/24 via 10.10.100.6")
    addRoute(r2, "198.51.100.0/24 via 10.10.100.6")
    addRoute(r2, "192.168.10.0/24 via 10.10.100.6")
    # r3
    # r4
    # r5
    # r6
